...
![Horse populations for all provinces in Canada from 1906–1972.](../results/horse_pops_plot.png){#fig-all-provinces}

We can see from @fig-all-provinces that Ontario, Saskatchewan and Alberta 
...
We present the standard deviations in Table @tbl-sd.
...
Additionally, note that in Table @tbl-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-all-provinces.
...
In @fig-largest-sd zoom in and look at the province of `{python} largest_sd` which had the largest spread of values in terms of standard deviation.
